...
- **Organization Workspaces** – Collaborative team workspaces with shared commands, RBAC admin access controls (Admin, Member, Viewer), usage analytics reporting, billing plan management (Free, Pro, Enterprise), private command registries, and Slack webhook integration
