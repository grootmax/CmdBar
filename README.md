...
- **Enterprise SSO Integration (SAML 2.0 & OIDC)** – Full Single Sign-On integration supporting Azure AD, Okta, and Google Workspace SSO, JIT user provisioning, group mapping, and session management
