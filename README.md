...
- **IoT Trigger Support** – Trigger commands from hardware devices via MQTT, HTTP Webhook listeners, Home Assistant bridge, and sensor-based condition rules with debouncing and cooldown support
