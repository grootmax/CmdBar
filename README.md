...
- **Enterprise Single Sign-On (SSO)** – Native SAML 2.0 & OIDC integration with Azure AD (Entra ID), Okta, and Google Workspace SSO, supporting PKCE, JIT provisioning, role/group mapping, session management, and dynamic category visibility filtering
