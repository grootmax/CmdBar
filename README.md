...
- **Numeric Keypad Shortcuts & Macro Pad** – Dedicated 10-key macro pad hardware support on numpad keys (`0-9`). Features configurable active layers (Default, Gaming, Dev), visual HUD overlay (`Super+KP_Multiply`), quick layer cycling (`Super+KP_Divide`), and full Libadwaita management app integration.
