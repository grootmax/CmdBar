...
- **Screenshot & Screen Capture** – Quick screen capture for full screen, window, or region with configurable hotkeys (`Super+Shift+3`, `Super+Shift+4`, `Super+Shift+5`), file/clipboard saving, image annotations (text, shapes, blur, crop), metadata stripping, and instant URL sharing
