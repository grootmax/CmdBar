...
- **Cron Scheduling Support** – Automate commands like cron with 5-field syntax or shorthands (`@daily`, `@hourly`), visual editor, timezone awareness, overlap prevention, error logging, and email report notifications
