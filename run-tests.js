...
import os from 'os';
import { validateInput, hasPlaceholder, substituteCommand, fuzzyMatch, highlightMatches, rankCommands, detectFormat, formatOutput, detectGitRepo, getGitStateSync, substituteGitPlaceholders, hasNonGitPlaceholders } from './extension/commandProcessor.js';
