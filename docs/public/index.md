...
- **Window Management**: Window control (close, move, resize, tile, switch workspace), global shortcuts, visual window preview, and support for GNOME and tiling WMs (i3, Sway, Hyprland).
