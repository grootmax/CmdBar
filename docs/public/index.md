...
- **Window Management Commands**: Control window close, move, resize, tile, switch workspace with custom shortcut keybindings, visual ASCII window layout previews, and multi-WM support (GNOME Shell, i3, sway, hyprland).
